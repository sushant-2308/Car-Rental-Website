    ...
    <>
      ...
      <Card>
        ...
        <Card.Body>
          ...
          <Alert variant="success">
            While Returning the vehicle it must contain 2 Litres of
            Petrol/Diesel.
          </Alert>
          <Alert variant="success">
            Incase of anything happen to the vehicle it will be the
      ...
      <Container>
        <Form>
          ...
          <Button variant="primary" type="submit">
            <Link className="btn-1" onClick={handleSubmit}>
              Submit
            </Link>
          </Button>
        </Form>
