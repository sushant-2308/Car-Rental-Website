          ...
          <Col md={50}>
            <CardGroup>
              <Card className="mt-5" width="80px">
                ...
                <Card.Body>
                  <Card.Title>Our Customers Always 100% Satisfied</Card.Title>
                  <hr />
                  <Card.Text>
                    Lorem ipsum dolor sit amet consectetur adipisicing elit.
                    Dolores odio quasi dicta eius, consequatur enim, obcaecati
                    dolorem eligendi esse quaerat numquam tempore illo doloribus
                    architecto laborum aperiam sed molestiae aspernatur.
                  </Card.Text>
                </Card.Body>
              </Card>
              <Card className="mt-5" width="80px">
